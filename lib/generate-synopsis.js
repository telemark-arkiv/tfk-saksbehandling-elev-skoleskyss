...
function showBosted (data) {
  ...
  if (data.bosted.bosted === 'folkeregistrert') {
    ...
    if (data['distance-see-dsf']) {
      outputs.push('Beregnet avstand til skole: ' + data['distance-see-dsf'].distance)
      outputs.push('Beregnet rute: ' + data['distance-see-dsf'].staticMapUrl)
    }
  }
  ...
  if (data.bosted.bosted === 'delt') {
    ...
    if (data['distance-see-delt']) {
      outputs.push('Beregnet avstand til skole: ' + data['distance-see-delt'].distance)
      outputs.push('Beregnet rute: ' + data['distance-see-delt'].staticMapUrl)
    }
  }
  ...
  if (data.bosted.bosted === 'hybel') {
    ...
    if (data['distance-see-hybel']) {
      outputs.push('Beregnet avstand til skole: ' + data['distance-see-hybel'].distance)
      outputs.push('Beregnet rute: ' + data['distance-see-hybel'].staticMapUrl)
    }
  }
