...
module.exports = miss.through(function (chunk, encoding, callback) {
  ...
  documentOut.archiveTitle = `${documentOutTitleStart} - bussøknad skoleskyss - ${skoleAar} - ${skoleNavn} - ${elevNavn}`
  documentOut.archiveOffTitle = `${documentOutTitleStart} - bussøknad skoleskyss - ${skoleAar} - ${skoleNavn}`
